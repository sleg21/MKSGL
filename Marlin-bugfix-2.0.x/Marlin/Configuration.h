...
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 691.5 }
...
/**
     ...
     #define Y_PROBE_OFFSET_FROM_EXTRUDER 10
      ...
      (0,0)
*/
#define X_PROBE_OFFSET_FROM_EXTRUDER 30.3  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 2.4  // Y offset: -front +behind [the nozzle]
